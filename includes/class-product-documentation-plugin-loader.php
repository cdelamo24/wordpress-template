 ...
 *
 * Maintain a list of all hooks that are registered throught
 * the plugin, and register them with the WordPress API. Call the
 * run function to execute the list of actions and filters.
 *
 * @package Product_Documentation_Plugin
 * @subpackage Product_Documentation_Plugin/includes
 * @author Cristian Mateos López <mateos.c19@gmail.com>
 */
class Product_Documentation_Plugin_Loader
{
    /**
     ...
     * @since   1.0.0
     * @access  private
     * @param   array       $hooks          The collection of hooks that is being registered (thats is, actions or filters).
